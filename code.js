...
(function() {
  var Board, Canvas, Food, Game, Point, Snake, SnakeSegment, backgroundColor, headColor, height, snakeColor, width,
  ...
  Board = (function() {
    ...
    Board.prototype.clear = function() {
      var x, y, _i, _results;
      _results = [];
      for (x = _i = 0; 0 <= height ? _i < height : _i > height; x = 0 <= height ? ++_i : --_i) {
        _results.push((function() {
          var _j, _results1;
          _results1 = [];
          for (y = _j = 0; 0 <= width ? _j < width : _j > width; y = 0 <= width ? ++_j : --_j) {
            console.log('setting: ', x, y);
            _results1.push(this.array[x][y] = 0);
          }
          return _results1;
        }).call(this));
      }
      ...
      for (x = _i = 0; 0 <= height ? _i < height : _i > height; x = 0 <= height ? ++_i : --_i) {
        _results.push((function() {
          ...
          for (y = _j = 0; 0 <= width ? _j < width : _j > width; y = 0 <= width ? ++_j : --_j) {
            ...
            _results1.push(ctx.fillRect(x * 10, y * 10, 10, 10));
          }
          return _results1;
        }).call(this));
      }
  ...
  Snake = (function() {
    ...
    Snake.prototype.bitHimself = function(x, y, head) {
      var segment;
      if (head == null) {
        head = true;
      }
  ...
  Game = (function() {
    ...
    Game.prototype.checkCollision = function() {
      ...
      if (this.snake.bitHimself(this.snake.head.x, this.snake.head.y, false)) {
        this.gameOver();
        return true;
      }
