...
(function() {
  var Board, Canvas, Food, Game, Point, Snake, SnakeSegment, backgroundColor, foodColor, headColor, height, randomInt, snakeColor, width,
  ...
  Game = (function() {
    ...
    Game.prototype.checkCollision = function() {
      ...
      if (this.snake.head.x < 0 || this.snake.head.x >= width || this.snake.head.y < 0 || this.snake.head.y >= height) {
        this.gameOver();
        return true;
      }
      return false;
